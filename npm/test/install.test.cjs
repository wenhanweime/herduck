...
function manifest(content = bytes) {
  return { version: '0.1.0-alpha.4', platforms: { [`${process.platform}-${process.arch}`]: {
    url: 'https://github.com/wenhanweime/herduck/releases/download/v0.1.0-alpha.4/herduck-test',
