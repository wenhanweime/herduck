...
#[serde(default)]
pub struct ProjectAdaptersConfig {
    pub codex: ProjectAdapterConfig,
    pub claude: ProjectAdapterConfig,
    pub pi: ProjectAdapterConfig,
    pub opencode: ProjectAdapterConfig,
    pub grok: ProjectAdapterConfig,
}
...
"#;
    ...
    #[test]
    fn projects_adapter_roots_parse_under_the_least_privilege_section() {
        let config: Config = toml::from_str(
            r#"
[projects.adapters.codex]
roots = ["~/history/codex", "/var/tmp/codex-history"]
...
"#,
        ...
        assert_eq!(config.projects.adapters.codex.roots.len(), 2);
        assert_eq!(
            config.projects.adapters.pi.roots,
