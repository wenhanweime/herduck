...
pub struct ProjectsViewState {
    pub snapshot: crate::projects::ProjectsSnapshot,
    pub grouping: ProjectGrouping,
    pub filter: ProjectFilter,
    pub query: String,
    pub search_focused: bool,
    pub search_restore_selection: Option<(usize, usize)>,
...
impl Default for ProjectsViewState {
    fn default() -> Self {
        Self {
            snapshot: crate::projects::ProjectsSnapshot::empty(),
            grouping: ProjectGrouping::Directories,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum ProjectSessionActivation {
    Live {
        session_key: String,
        workspace_id: String,
        pane_id: String,
