...
pub struct App {
    ...
    pub(crate) project_service: crate::projects::ProjectService,
...
impl App {
    pub fn new(
        ...
        let project_roots = crate::projects::adapters::resolve_roots(&config.projects);
    ...
    pub fn assume_handoff_ownership(&mut self) {
        ...
        self.activate_project_service_after_handoff();
    }
    ...
    pub async fn run(&mut self, terminal: &mut DefaultTerminal) -> io::Result<()> {
        ...
        while !self.state.should_quit {
            ...
            if self.sync_projects_snapshot() {
                needs_render = true;
            }
