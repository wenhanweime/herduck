...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::ProjectOverviewGet(_) => "project.overview.get",
        Method::ProjectFollowupStart(_) => "project.followup.start",
        Method::ProjectFollowupGet(_) => "project.followup.get",
        Method::ProjectFollowupCancel(_) => "project.followup.cancel",
