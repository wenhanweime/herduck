...
pub use self::{
    ...
    model::{
        ...
        ShellModeConfig, SidebarCollapsedModeConfig, SummaryConfig, SummaryModeConfig,
        SummaryProviderConfig, SummaryProviderKind, TitleLanguage, ToastClipboardPosition,
        ToastConfig, ToastDelivery, ToastHerduckPosition, UpdateChannelConfig,
